...
<head>
	...
	<meta http-equiv="refresh" content="5; url=blugrass_band.php"</>
...
<body>
	<header>
		...
		<h1>Tennessee Valley Old Time Fiddlers Convention Winners</h1>
			...
			<ul>
				...
				<li><a href="beginning_fiddler11.php" class="current">Beginning Fiddler (Age 11 - 15)</a></li>
	...
	<section>
		<h2>Beginning Fiddler (Age 11-15)</h2>
		<?php
