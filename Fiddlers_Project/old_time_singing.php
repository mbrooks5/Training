...
<head>
	...
	<meta http-equiv="refresh" content="5; url=senior_fiddler.php"</>
	...
	<header>
		...
		<h1>Tennessee Valley Old Time Fiddlers Convention Winners</h1>
			...
			<ul>
				...
				<li><a href="old_time_singing.php" class="current">Old Time Singing</a></li>
				<li><a href="senior_fiddler.php">Senior Fiddler</a></li>
			</ul>
		</nav>
	
	<section>
		<h2>Old Time Singing</h2>
		<?php
