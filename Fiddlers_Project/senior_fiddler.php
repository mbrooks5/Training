...
<head>
	...
	<meta http-equiv="refresh" content="5; url=beginning_fiddler10.php"</>
	...
	<header>
		...
		<h1>Tennessee Valley Old Time Fiddlers Convention Winners</h1>
			...
			<ul>
				...
				<li><a href="senior_fiddler.php" class="current">Senior Fiddler</a></li>
			</ul>
		</nav>
	
	<section>
		<h2>Senior Fiddler</h2>
		<?php
