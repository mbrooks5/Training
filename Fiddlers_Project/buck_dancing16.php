...
<head>
	...
	<meta http-equiv="refresh" content="5; url=classic_old_time_banjo.php"</>
...
<body>
	<header>
		...
		<h1>Tennessee Valley Old Time Fiddlers Convention Winners</h1>
			...
			<ul>
				...
				<li><a href="buck_dancing16.php" class="current">Buck Dancing (Age 16 & older)</a></li>
	...
	<section>
		<h2>Buck Dancing (Age 16 & older)</h2>
		<?php
